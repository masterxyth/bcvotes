...
def show_tables():
    ...
    return render_template('index.html',tables=[data.to_html(classes='data')], #returning index.html file from templates, using the data returned as a table in html with Class Data
